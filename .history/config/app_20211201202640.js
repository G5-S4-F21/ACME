...
const tennisTrainer = require("../models/tennisTrainer");
let User = userModel.User;
passport.use(User.createStrategy(),tennisTrainerSeeker.tennisTrainerSeeker.createStrategy(),tennisTrainer.tennisTrainer.createStrategy());
