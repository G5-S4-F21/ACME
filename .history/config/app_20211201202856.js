...
const tennisTrainerModel = require('../models/tennisTrainer.js');
let User = userModel.User;
let tennisTrainer = tennisTrainerModel.tennisTrainer;
passport.use(User.createStrategy(),tennisTrainer.createStrategy());
