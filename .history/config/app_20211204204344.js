...
passport.serializeUser(seekerModel.default.serializeUser(),trainerModel.default.serializeUser());
passport.deserializeUser(seekerModel.default.deserializeUser(),trainerModel.default.deserializeUser() );
