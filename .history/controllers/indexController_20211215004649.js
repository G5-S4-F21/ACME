        ...
        if(err){
            ...
            const options = {
                ...
                html           : '<h4>Please click the link below to reset your password</h4><p>' +
                    ...
                    '<p><a href=https://lawntennistrainer.herokuapp.com/recoverPassword?accountType='+req.query.user_account_type+'&UUID='+trainers[0]._id+'">https://lawntennistrainer.herokuapp.com/recoverPassword?accountType='+req.query.user_account_type+'&UUID='+trainers[0]._id+'</a>'
            };
