...
function DisplayRegisterSeekerPage(req, res, next) {
    if (!req.user) {
        return res.render('seekerViews/seekerInex', { title: 'Seeker registration', page: 'registerSeeker', messages: req.flash('registerMessage'), displayName: (0, Util_1.UserDisplayName)(req) });
    }
